...
- (void)createTable:(NSInteger)index
    ...
    table.mj_header =  [MJRefreshNormalHeader headerWithRefreshingBlock:^{
        ...
        if (strongSelf.scrollStatusDelegate && [strongSelf.scrollStatusDelegate respondsToSelector:@selector(refreshViewWithTag:isHeader:)]) {
            [strongSelf.scrollStatusDelegate refreshViewWithTag:table.tag
                                                     isHeader:YES];
